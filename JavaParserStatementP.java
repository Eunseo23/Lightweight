...
public class NotificationService extends NotificationListenerService {
    ...
    public static final String ACTION_DISMISS_NOTIFICATION = NotificationActionReceiver.class.getSimpleName() + ".dismiss_notification";

    public static final String ACTION_PREFERENCE_CHANGED = NotificationService.class.getSimpleName() + ".preference_changed";

    public static final String ACTION_QUIET_HOUR_CHANGE = NotificationService.class.getSimpleName() + ".quiet_hour_changed";
    ...
    private boolean isInBlackList(StatusBarNotification notification) {
        return notification.getNotification().priority < Notification.PRIORITY_DEFAULT || mAppList.shouldPeekWakeUp(notification);
    }
